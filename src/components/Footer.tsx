      ...
      <div className="container">
        ...
        <div className="row">
          <div className="row__item">
            <img src={assetUrl('logos/github_icon.png')} alt="GitHub" className="footer__logo" />
          ...
          <div className="row__item">
            <img
              src={assetUrl('logos/github_issues.png')}
              alt="GitHub Issues"
          ...
          <div className="row__item">
            <img src={assetUrl('logos/feedback.png')} alt="Feedback" className="footer__logo" />
