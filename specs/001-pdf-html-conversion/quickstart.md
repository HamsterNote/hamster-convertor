...
4. Download a single merged HTML file containing all successful conversions.
...
- Confirm the downloaded merged HTML file contains all successful PDF conversions.
